...
export class CreateMessagesTables1711590247248 implements MigrationInterface {
    name = 'CreateMessagesTables1711590247248'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`messages\` (\`id\` int NOT NULL AUTO_INCREMENT, \`senderRole\` enum ('user', 'openAi') NULL, \`content\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
